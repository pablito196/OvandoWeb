...
public class Compras {
    ...
    public void getReporte(String ruta, Integer idCompra) throws ClassNotFoundException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
